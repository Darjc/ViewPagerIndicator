...
namespace Com.RD.Draw.Drawer.Type {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.rd.draw.drawer.type']/class[@name='ColorDrawer']"
	[global::Android.Runtime.Register ("com/rd/draw/drawer/type/ColorDrawer", DoNotGenerateAcw=true)]
	public partial class ColorDrawer : global::Java.Lang.Object {

		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/rd/draw/drawer/type/ColorDrawer", typeof (ColorDrawer));
		...
		protected ColorDrawer (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.rd.draw.drawer.type']/class[@name='ColorDrawer']/constructor[@name='ColorDrawer' and count(parameter)=2 and parameter[1][@type='android.graphics.Paint'] and parameter[2][@type='com.rd.draw.data.Indicator']]"
		[Register (".ctor", "(Landroid/graphics/Paint;Lcom/rd/draw/data/Indicator;)V", "")]
		public unsafe ColorDrawer (global::Android.Graphics.Paint paint, global::Com.RD.Draw.Data.Indicator indicator)
...
#pragma warning disable 0169
		...
		{
			global::Com.RD.Draw.Drawer.Type.ColorDrawer __this = global::Java.Lang.Object.GetObject<global::Com.RD.Draw.Drawer.Type.ColorDrawer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.rd.draw.drawer.type']/class[@name='ColorDrawer']/method[@name='draw' and count(parameter)=5 and parameter[1][@type='android.graphics.Canvas'] and parameter[2][@type='com.rd.animation.data.Value'] and parameter[3][@type='int'] and parameter[4][@type='int'] and parameter[5][@type='int']]"
