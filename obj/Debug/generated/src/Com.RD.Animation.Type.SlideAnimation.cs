...
namespace Com.RD.Animation.Type {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.rd.animation.type']/class[@name='SlideAnimation']"
	[global::Android.Runtime.Register ("com/rd/animation/type/SlideAnimation", DoNotGenerateAcw=true)]
	public partial class SlideAnimation : global::Com.RD.Animation.Type.BaseAnimation {

		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/rd/animation/type/SlideAnimation", typeof (SlideAnimation));
		...
		protected SlideAnimation (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.rd.animation.type']/class[@name='SlideAnimation']/constructor[@name='SlideAnimation' and count(parameter)=1 and parameter[1][@type='com.rd.animation.controller.ValueController.UpdateListener']]"
		[Register (".ctor", "(Lcom/rd/animation/controller/ValueController$UpdateListener;)V", "")]
		public unsafe SlideAnimation (global::Com.RD.Animation.Controller.ValueController.IUpdateListener listener)
...
#pragma warning disable 0169
		...
		{
			global::Com.RD.Animation.Type.SlideAnimation __this = global::Java.Lang.Object.GetObject<global::Com.RD.Animation.Type.SlideAnimation> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.CreateAnimator ());
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='com.rd.animation.type']/class[@name='SlideAnimation']/method[@name='createAnimator' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.rd.animation.type']/class[@name='SlideAnimation']/method[@name='progress' and count(parameter)=1 and parameter[1][@type='float']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.rd.animation.type']/class[@name='SlideAnimation']/method[@name='with' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
		[Register ("with", "(II)Lcom/rd/animation/type/SlideAnimation;", "GetWith_IIHandler")]
		public virtual unsafe global::Com.RD.Animation.Type.SlideAnimation With (int coordinateStart, int coordinateEnd)
		{
			const string __id = "with.(II)Lcom/rd/animation/type/SlideAnimation;";
			try {
