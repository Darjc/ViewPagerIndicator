...
namespace Com.RD.Draw.Drawer.Type {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.rd.draw.drawer.type']/class[@name='DropDrawer']"
	[global::Android.Runtime.Register ("com/rd/draw/drawer/type/DropDrawer", DoNotGenerateAcw=true)]
	public partial class DropDrawer : global::Java.Lang.Object {

		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/rd/draw/drawer/type/DropDrawer", typeof (DropDrawer));
		...
		protected DropDrawer (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.rd.draw.drawer.type']/class[@name='DropDrawer']/constructor[@name='DropDrawer' and count(parameter)=2 and parameter[1][@type='android.graphics.Paint'] and parameter[2][@type='com.rd.draw.data.Indicator']]"
		[Register (".ctor", "(Landroid/graphics/Paint;Lcom/rd/draw/data/Indicator;)V", "")]
		public unsafe DropDrawer (global::Android.Graphics.Paint paint, global::Com.RD.Draw.Data.Indicator indicator)
...
#pragma warning disable 0169
		...
		{
			global::Com.RD.Draw.Drawer.Type.DropDrawer __this = global::Java.Lang.Object.GetObject<global::Com.RD.Draw.Drawer.Type.DropDrawer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.rd.draw.drawer.type']/class[@name='DropDrawer']/method[@name='draw' and count(parameter)=4 and parameter[1][@type='android.graphics.Canvas'] and parameter[2][@type='com.rd.animation.data.Value'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
