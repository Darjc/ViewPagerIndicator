...
namespace Com.RD.Animation {

	// Metadata.xml XPath class reference: path="/api/package[@name='com.rd.animation']/class[@name='AnimationManager']"
	[global::Android.Runtime.Register ("com/rd/animation/AnimationManager", DoNotGenerateAcw=true)]
	public partial class AnimationManager : global::Java.Lang.Object {

		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/rd/animation/AnimationManager", typeof (AnimationManager));
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.rd.animation']/class[@name='AnimationManager']/constructor[@name='AnimationManager' and count(parameter)=2 and parameter[1][@type='com.rd.draw.data.Indicator'] and parameter[2][@type='com.rd.animation.controller.ValueController.UpdateListener']]"
		[Register (".ctor", "(Lcom/rd/draw/data/Indicator;Lcom/rd/animation/controller/ValueController$UpdateListener;)V", "")]
		public unsafe AnimationManager (global::Com.RD.Draw.Data.Indicator indicator, global::Com.RD.Animation.Controller.ValueController.IUpdateListener listener)
...
#pragma warning disable 0169
		...
		{
			global::Com.RD.Animation.AnimationManager __this = global::Java.Lang.Object.GetObject<global::Com.RD.Animation.AnimationManager> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.Basic ();
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='com.rd.animation']/class[@name='AnimationManager']/method[@name='basic' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.rd.animation']/class[@name='AnimationManager']/method[@name='end' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.rd.animation']/class[@name='AnimationManager']/method[@name='interactive' and count(parameter)=1 and parameter[1][@type='float']]"
